 ...
 */
const NPCModal = ({ npcData, onClose }) => {
    ...
    return (
        ...
        >
            <div
                className={`bg-disco-panel border-2 ${borderColor} p-6 rounded-lg max-w-lg w-full mx-4 max-h-[80vh] overflow-y-auto shadow-2xl`}
            ...
            >
                ...
                <div className="flex gap-4 mb-4">
                    ...
                    <div className="flex-1">
                        <h2 className={`text-2xl font-serif font-bold ${textColor}`}>{npcData.name}</h2>
                        <p className="text-disco-muted italic">{npcData.role}</p>
                    ...
                    <button
                        onClick={onClose}
                        className="text-disco-muted hover:text-disco-paper text-2xl leading-none"
                    >
                        ×
                    </button>
                </div>
                ...
                {/* Description */}
                {npcData.description && (
                    <div className="mb-4 p-3 bg-black/30 rounded italic text-disco-paper/80">
                        "{npcData.description}"
                    </div>
                )}
 ...
 */
const NPCHoverCard = ({ name, characters = {} }) => {
